...
- Telemetry-v2 extended datasets may be generated by build_dataset.py for
  analysis and feature validation, but this script's default feature pool is
  intentionally unchanged until a separate ML retraining/validation step is
  approved.
